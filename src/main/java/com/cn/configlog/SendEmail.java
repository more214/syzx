...
public class SendEmail {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 设置发件人邮箱地址
			message.setFrom(new InternetAddress("23044772@qq.com"));

			// 设置收件人邮箱地址
			message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("dumingyan@everjiankang.com"));

			// 设置邮件主题
			message.setSubject("测试发送邮件TestNG");

			// 创建一个MimeBodyPart的对象，以便添加内容
			BodyPart messageBodyPart1 = new MimeBodyPart();

			// 设置邮件正文内容
			messageBodyPart1.setText("这个是邮件的正文部分TestNG");
			...
			String filename = ".\\test-output\\custom-report.html";
