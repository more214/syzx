...
public class ConfigReader {
	...
	private static final String CONFIGFILE = "./TestConfig/rerun.properties";
	...
	private Properties getConfig(String propertyFileName) {
		...
		try {
			...
			properties = null;
			FileHelper.info("FileNotFoundException:" + propertyFileName);
		} catch (IOException e) {
			properties = null;
			FileHelper.info("IOException:" + propertyFileName);
		}
		return properties;
	}
}